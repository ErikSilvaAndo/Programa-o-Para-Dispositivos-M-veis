...
export default function TelaAzul({imagem}){
    ...
    return(
        <ScrollView>
            <View style={estilos.container}>
                    <LinearGradient colors={['#1875E9', '#041832', '#01080E']}>
                        <View>
                <ImageBackground source={Linhas} style={estilos.fundo}>
                            <Text style={estilos.titulo}>Hora de voltar à superfície<br/><strong>Faça uma pausa longa.</strong></Text>
                            ...
                            <View style={estilos.cardCardTimer}>
                                <View style={estilos.cardTimer}>
                                    ...
                                    <View style={estilos.cardTimerNumero}>
                                        <Text style={estilos.timer}>15:00</Text>
                                    </View>
                                    ...
                                    <View style={estilos.cardCardComecar}>
                                        <View style={estilos.cardCardCardComecar}>
                                            <LinearGradient colors={['#B872FF', '#144480', '#144480']} style={estilos.linearGradient}>
                                                <Text style={estilos.textoComecar}>▶ Começar</Text>
                                            </LinearGradient>
                                        </View>
                                    </View>
                                </View>
                                ...
                                <View style={estilos.liha} />
                                <View style={estilos.cardTituloTarefa}>
                                    <Text style={estilos.tituloTarefa}>Lista de tarefa</Text>
                                </View>
                                <View>
                                    <View>
                                        <View>
                                            <View style={estilos.cardTarefaVerde}>
                                                <View>
                                                    <Text>√</Text>
                                                </View>
                                        ...
                                        <View style={estilos.cardCardAdicionaTarefa}>
                                            <View style={estilos.cardAdicionaTarefa}>
                                                <Text style={estilos.tituloAdcionaTarefa}>Adicionar tarefa</Text>
                                                <View style={estilos.cardPergunta}>
                                                    <Text style={estilos.textoPergunta}>No que você está trabalhando?</Text>
                                                </View>
                                                <View style={estilos.cardIcones}>
                                                    <Text style={estilos.icones}>🗑️ Deletar</Text>
                                                    <View>
                                                        <Text style={estilos.icones}>X Cancelar</Text>
                                                    </View>
                                                    <View style={estilos.iconeSalvar}>
                                                        <Text style={estilos.textoIconeSalvar}>Salvar</Text>
                                                    </View>
                                                    <View>
                                                        <View>
                                                            <Text>+</Text>
                                                        </View>
                                                        <View>Adicionar nova tarefa</View>
                                                    </View>
                                                </View>
                                            </View>
                                        </View>
